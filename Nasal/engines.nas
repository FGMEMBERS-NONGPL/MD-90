...
var eng_one_start = func {
	if ((getprop("/controls/engines/engine[0]/cutoff") == 0) and (getprop("/controls/engines/engine[0]/starting") == 1) and (getprop("/engines/engine[0]/n2-actual") >= 16) 
...
var eng_two_start = func {
	if ((getprop("/controls/engines/engine[1]/cutoff") == 0) and (getprop("/controls/engines/engine[1]/starting") == 1) and (getprop("/engines/engine[1]/n2-actual") >= 16) 
