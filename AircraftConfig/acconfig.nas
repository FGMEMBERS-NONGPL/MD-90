...
var main_dlg = gui.Dialog.new("sim/gui/dialogs/acconfig/main/dialog", "Aircraft/MD-90/AircraftConfig/main.xml");
var welcome_dlg = gui.Dialog.new("sim/gui/dialogs/acconfig/welcome/dialog", "Aircraft/MD-90/AircraftConfig/welcome.xml");
var ps_load_dlg = gui.Dialog.new("sim/gui/dialogs/acconfig/psload/dialog", "Aircraft/MD-90/AircraftConfig/psload.xml");
var ps_loaded_dlg = gui.Dialog.new("sim/gui/dialogs/acconfig/psloaded/dialog", "Aircraft/MD-90/AircraftConfig/psloaded.xml");
var init_dlg = gui.Dialog.new("sim/gui/dialogs/acconfig/init/dialog", "Aircraft/MD-90/AircraftConfig/ac_init.xml");
init_dlg.open();
...
var taxi_b = func {
	...
	var eng_two_chk = setlistener("/engines/engine[1]/n2-actual", func {
		if (getprop("/engines/engine[1]/n2-actual") >= 16) {
...
var taxi_d = func {
	...
	var eng_one_chk = setlistener("/engines/engine[0]/n2-actual", func {
		if (getprop("/engines/engine[0]/n2-actual") >= 16) {
